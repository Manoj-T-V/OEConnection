    ...
    public class RLContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<PlanProcedureUser>(typeBuilder =>
            {
                ...
                typeBuilder.HasOne(pu => pu.Plan).WithMany(p => p.PlanProcedureUsers).HasForeignKey(pu => pu.PlanId);
                typeBuilder.HasOne(pu => pu.Procedure).WithMany(p => p.PlanProcedureUsers).HasForeignKey(pu => pu.ProcedureId);
