...
{
    public partial class AddAssignedUse1r : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("CREATE TABLE IF NOT EXISTS Plans (PlanId INTEGER PRIMARY KEY AUTOINCREMENT, CreateDate TEXT NOT NULL, UpdateDate TEXT NOT NULL);");
