...
const Plan = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      const assignedUsers = await getAssignedUsers(id);
  ...
  const handleAssignUser = async (procedureId, userId) => {
    await assignUserToProcedure(procedureId, userId);
                    ...
                    <div>
                      {procedures.map((p) => (
                        <ProcedureItem
                          ...
                          assignedUser={assignedUsers[p.procedureId]}
                        />
                      ))}
                    </div>
                  </div>
